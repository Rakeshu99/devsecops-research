...
| Comparative analysis | 🔶 In progress — all six metrics documented with real data in `docs/comparative-analysis.md`; verdict drafted, formal chapter write-up ongoing |
